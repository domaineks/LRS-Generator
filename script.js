...
const TAX_CONSTANTS = {
    ...
    WITHHOLD_RATES: {
        LOCAL: {
            ...
            '9A': { threshold: 20010, rate: 0.10 },
            '9B': { threshold: 20010, rate: 0.10 },
...
function getIncomeTypeDescription(incomeType, nationality) {
    const descriptions = {
        'local': {
            ...
            '9A': '無免稅額，扣除所屬類別費用率後計入個人所得。達20,010元，需代扣所得稅10%。達20,000元，需扣繳2.11%補充保費。提供職業工會的健保加保證明，不須扣2.11%補充保費。',
            '9B': '可先扣18萬免稅額，再扣除30%費用後計入個人所得。達20,010元，需代扣所得稅10%。達20,000元，需扣繳2.11%補充保費。提供職業工會的健保加保證明，不須扣2.11%補充保費。',
            '92': '不須扣繳、不須2.11%補充保費。'
        },
        'foreign': {
